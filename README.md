...
│
└── docs/
    ├── Architecture_and_Internals.md   # Shell / datapath / CV-X-IF protocol, wiring reference
...
- [Architecture and Internals](docs/Architecture_and_Internals.md) — What HWExplore is, the CV-X-IF shell/mux/scratchpad, the ISA `funct3`/`funct7` dispatch scheme, detailed port-level wiring reference, and multi-cycle scheduling.
